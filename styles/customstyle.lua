...
function stTable.initialize()
    ...
    for a = 1, 4 do
		for i = 1, 5 do
			...
			lb.groupName[var]:SetPoint("TOPLEFT", lb.groupBF[var], "TOPLEFT", 24*optionsTable.frameWidth*0.009009009, 3*optionsTable.frameHeight*0.023255814)
			...
			lb.groupRole[var]:SetPoint("TOPLEFT", lb.groupBF[var], "TOPLEFT", 6*optionsTable.frameWidth*0.009009009,  6*optionsTable.frameHeight*0.023255814 )
			lb.groupRole[var]:SetHeight(16*optionsTable.frameWidth*0.009009009)
			lb.groupRole[var]:SetWidth(16*optionsTable.frameHeight*0.023255814)
