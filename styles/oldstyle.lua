...
function stTable.fastInitialize()
	optionsTable=lb.styles.getConfiguration("oldstyle") --gets configuration from savedvars and stores it into the local optionsTable
...
function stTable.initializeIndex(index)
    ...
    lb.frames[var].groupMask:SetVisible(true)
